...
public class Robot extends TimedRobot {
  ...
  public void teleopPeriodic() {
    ...
    if(secondStick.getRawAxis(1)>-0.04&&secondStick.getRawAxis(1)<0.04){motorLeft.set(0);} else {
      motorLeft.set(-0.5*secondStick.getRawAxis(1));
    } 
    
    if(secondStick.getRawAxis(3)>-0.04&&secondStick.getRawAxis(3)<0.04){motorRight.set(0);} else {
      motorRight.set(-0.5*secondStick.getRawAxis(3));
    }
