...
public class Constants {
    ...
    public static final double SLEWRATELIMITER_RIGHT_RATE = 2.2;
    public static final double SLEWRATELIMITER_LEFT_RATE = 2.2;

    // Speeds
    public static final double SPEED_EXTENDER = 1;
    public static final double SPEED_CLAW = 0.7;
    public static final double SPEED_DRIVE = .9;
    public static final double SPEED_SLOW_DRIVE = 0.7;

    // Autonomous
    public static final double AUTONOMOUS_EXTENDER_TIME = 3;
}
